...
+------------------------------------------+--------------------------------------------+
| WHEN\_ANCESTOR\_OF\_FOCUSED\_COMPONENT   | 当在组件或是在组件的容器中按下时激活按键   |
+------------------------------------------+--------------------------------------------+
